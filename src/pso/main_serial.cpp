 ...
 *     - pso/methods.hpp: declares pso_serial(...) returning OutputObject.
 *     - interfaces/interfaces.hpp: declares TestFunction and OutputObject.
 *     - interfaces/functions.hpp: defines the concrete TestFunction subclasses.
