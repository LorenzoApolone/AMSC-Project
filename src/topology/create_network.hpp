...
/**
 * @brief Generate a small-world network using an explicit seed.
 *
 * @param[in] N Number of nodes.
 * @param[in] p Rewiring probability in the range [0, 1].
 * @param[out] adjacency_list Output adjacency list of size N.
 * @param[in] seed Explicit seed for deterministic behavior.
 */
 ...
 */
void create_network(int N, double p, std::vector<std::vector<int>> &adjacency_list, std::mt19937 &gen);
...
/**
 * @brief Generate a scale-free network using an explicit seed.
 *
 * @param[in] N Number of nodes.
 * @param[in] m Number of links added by each new node.
 * @param[out] adjacency_list Output adjacency list of size N.
 ...
 */
void create_scale_free_network(int N, int m, std::vector<std::vector<int>> &adjacency_list, std::mt19937 &gen);
...
/**
 * @brief Generate an Erdos-Renyi random graph using an explicit seed.
 *
 * @param[in] N Number of nodes.
 * @param[in] p Edge probability in the range [0, 1].
 * @param[out] adjacency_list Output adjacency list of size N.
 ...
 */
void create_random_network(int N, double p, std::vector<std::vector<int>> &adjacency_list, std::mt19937 &gen);
