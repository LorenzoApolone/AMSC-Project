        ...
        for line in f:
            ...
            if line.startswith('=> ESECUZIONE COMANDO:'):
                ...
                try:
                    ...
                    if current_np is not None and current_np > 0:
...
def main():
    ...
    plt.title('Communication Overhead vs Cores (Weak Scaling Dim=64)')
    plt.grid(True)
    plt.legend()
    
    output_png = 'weak_dim64_overhead_plot.png'
